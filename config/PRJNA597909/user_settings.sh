...
export PIPELINE_NAME="smansoni_prjna597909_wbps19"
export ORGANISM_NAME="Schistosoma_mansoni"
export REFERENCE_ID="Schistosoma_mansoni_SM_V10_WBPS19"
export PIPELINE_PROJECTS="PRJNA597909"
export SCRATCH_ROOT="${HF_DATA_ROOT}"
export METADATA_FINAL="${HF_PACKAGE_ROOT}/metadata/PRJNA597909/metadata.csv"
...
export QUANT_DIR="${HF_RESULTS_ROOT}/PRJNA597909/compatibility/quants"

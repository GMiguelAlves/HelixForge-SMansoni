...
export PIPELINE_NAME="smansoni_prjeb32839_wbps19"
export ORGANISM_NAME="Schistosoma_mansoni"
export REFERENCE_ID="Schistosoma_mansoni_SM_V10_WBPS19"
export PIPELINE_PROJECTS="PRJEB32839"
export SCRATCH_ROOT="${HF_DATA_ROOT}"
export METADATA_FINAL="${HF_PACKAGE_ROOT}/metadata/PRJEB32839/metadata.csv"
...
export QUANT_DIR="${HF_RESULTS_ROOT}/PRJEB32839/compatibility/quants"
